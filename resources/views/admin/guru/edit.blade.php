...
<div class="card">
    ...
    <div class="card-body">
        <form action="{{ route('gurus.update', $data->id) }}" method="post" enctype="multipart/form-data">
                            ...
                            <div class="card card-primary">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" id="id_card" name="id_card" class="form-control" value="{{$data->id_card}}" readonly>
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        <select name="jenis_kelamin" id="jenis_kelamin" class="form-control">
                                            <option value="L" @if($data->jenis_kelamin == "L") {{ "selected" }} @endif>L</option>
                                            <option value="P" @if($data->jenis_kelamin == "P") {{ "selected" }} @endif>P</option>
                                        </select>
                                    </div>
                                    <div class="form-group">
                                        <select name="id_mapel" id="id_mapel" class="form-control">
                                            @foreach ($mapel as $mapelRow)
                                            @if($data->id_mapel==$mapelRow->id)

                                            <option value="{{ $mapelRow->id }}" selected>{{ $mapelRow->nama_mapel }}</option>
                                            @else
