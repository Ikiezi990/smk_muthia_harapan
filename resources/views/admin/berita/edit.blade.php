                            ...
                            <div class="card card-primary">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" id="judul_berita" name="judul_berita" class="form-control" value="{{ $data->judul_berita }}">
                                    </div>
                                    <div class="form-group">
                                        <label for="judul_berita">Isi Berita</label>
                                        <textarea id="summernote" height="500" name="isi_berita">
                                        {{ $data->isi_berita }}
                                        </textarea>
                                    </div>
